...
#define TOOLHEAD_LEAVE_START_X 4
  ...
  private:
    ...
    static void blocks() {
        ...
        // Pick/leave cycles
            ...
            Cody::addPathPoint(fusionData.position.x, MOSAIC_Y + BLOCK_DISTANCE_MOSAIC * (position - 1) + 4);
